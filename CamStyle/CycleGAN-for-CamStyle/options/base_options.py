...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--from_name', type=str, default='market1501', help='frequency of saving checkpoints at the end of epochs')
        parser.add_argument('--from_path', type=str, default='datasets', help='frequency of saving checkpoints at the end of epochs')
        parser.add_argument('--to_name', type=str, default='market1501', help='frequency of saving checkpoints at the end of epochs')
        parser.add_argument('--to_path', type=str, default='datasets', help='frequency of saving checkpoints at the end of epochs')
        ...
        parser.add_argument('--dataset_mode', type=str, default='uda_reid', help='chooses how datasets are loaded. [unaligned | aligned | single]')
