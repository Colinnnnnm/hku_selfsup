...
transform = transforms.Compose(
    [transforms.RandomHorizontalFlip(),
     transforms.Resize((load_size_h, load_size_w), InterpolationMode.BICUBIC),
     transforms.RandomCrop((crop_size_h, crop_size_w)),
     transforms.ToTensor(),
     transforms.Normalize(mean=[0.5] * 3, std=[0.5] * 3)])
	 
test_transform = transforms.Compose(
    [transforms.Resize((crop_size_h, crop_size_w), InterpolationMode.BICUBIC),
     transforms.ToTensor(),
     transforms.Normalize(mean=[0.5] * 3, std=[0.5] * 3)])
...
a_loader = DataLoader(a_data, batch_size=batch_size, shuffle=True, num_workers=0)
b_loader = DataLoader(b_data, batch_size=batch_size, shuffle=True, num_workers=0)
a_test_loader = DataLoader(a_test_data, batch_size=1, shuffle=True, num_workers=0)
b_test_loader = DataLoader(b_test_data, batch_size=1, shuffle=True, num_workers=0)
